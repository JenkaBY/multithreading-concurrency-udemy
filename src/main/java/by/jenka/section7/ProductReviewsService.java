...
public class ProductReviewsService {
    ...
    private final ReadWriteLock productIdToReviewsLock = new ReentrantReadWriteLock();
    private final Lock readLock = productIdToReviewsLock.readLock();
    private final Lock writeLock = productIdToReviewsLock.writeLock();
